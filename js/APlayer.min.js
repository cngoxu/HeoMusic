...
function scrollLrc(){
    var container = document.getElementsByClassName("aplayer-lrc")[0];
    var y1 = document.querySelector("#heoMusic-page .aplayer-info .aplayer-lrc p").getBoundingClientRect().top
    var rect = document.getElementsByClassName("aplayer-lrc-current")[0].getBoundingClientRect()
    var y2 = rect.top
    var h = 0.5 * rect.height
    var half = 0.5 * container.getBoundingClientRect().height;
    if(y2 + h - y1 > half){
        container.scrollTo({
            top: y2 + h - y1 - half,
            behavior: "smooth"
    ...
    //console.log(document.getElementsByClassName("aplayer-lrc-current")[0].innerHTML)
}